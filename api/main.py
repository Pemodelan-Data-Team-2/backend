...
def get_pa_counts_by_cc():
    ...
    """
    return create_reports.patient_admission_count_by_care_center()
...
def get_pa_counts_by_room_type():
    ...
    Function to get formatted data for Statistics page in frontend
    """
    return create_reports.patient_admisson_count_by_room_type()
...
def get_carecenters():
    ...
    """
    return create_reports.care_centers_table()
